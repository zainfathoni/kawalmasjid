  ...
  ),
  {
    variants: {
      variant: {
        ...
        outline:
          "border-2 border-surface-100 bg-transparent text-brand-800 hover:bg-surface-100/30 dark:border-surface-700 dark:text-brand-200 hover:dark:bg-surface-800/30",
